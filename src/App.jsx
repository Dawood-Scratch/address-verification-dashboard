...
// ─── Sidebar ──────────────────────────────────────────────────────────────────
function Sidebar({ page, setPage, orgName, orgId, role, pendingCount, onLogout }) {
      ...
      <div className="px-3 py-4 border-t border-gray-100 space-y-2">
        {orgId && (
          <div className="px-3 py-2 bg-gray-50 rounded-lg">
            <div className="text-xs text-gray-400 mb-1">Organisation ID</div>
            <div className="flex items-center justify-between gap-1">
              <span className="text-xs font-mono text-gray-700 truncate">{orgId}</span>
              <button
                onClick={copyOrgId}
...
export default function App() {
  ...
  return (
    <div className="flex h-screen bg-slate-50">
      <Sidebar page={page} setPage={setPage} orgName={orgName} orgId={user.org?.id || ''} role={role} pendingCount={pendingOverrides} onLogout={handleLogout} />
